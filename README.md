...
- Upload signatures from `api/cloudinary-sign` are handed out only against a verified Firebase ID token carrying the admin role — viewers never upload, and a signature is write access to the Cloudinary account
