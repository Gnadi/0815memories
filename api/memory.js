// Vercel Serverless Function: POST /api/memory (create) and DELETE /api/memory?id=X
// Admin-only. Creates or deletes a memory document in Firestore.
...
export default async function handler(req, res) {
  ...
  if (req.method === 'POST') {
    const { title, description, quote, images, category, location, date, featured } = req.body ?? {}
